                ...
                <fieldset>
                  ...
                  <div tw="relative">
                    <input
                      ...
                      type="email"
                      name="email"
                      className="peer text-md focus:outline-none mb-10 h-10 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:border-yellow-600"
